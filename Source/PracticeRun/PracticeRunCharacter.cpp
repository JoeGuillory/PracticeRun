...
#include "PracticeRunProjectile.h"
...
APracticeRunCharacter::APracticeRunCharacter()
{
...
void APracticeRunCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void APracticeRunCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APracticeRunCharacter::Move);
...
void APracticeRunCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APracticeRunCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
